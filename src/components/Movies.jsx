...
const Moviecategory = (props) => {
    ...
    return (
        <div className="card mt-12 bmd:mt-24 w-[320px] pad:w-[400px] b-pad:w-[480px] sm:w-[530px] lg:w-[350px] border-black p-2 hover:cursor-pointer transition hover:scale-105">
            <img src={`https://image.tmdb.org/t/p/w500${img}`} alt="Image" loading='lazy' style={{ minWidth: "100%", maxWidth: "100%", minHeight: "100%", maxHeight: "100%" }} className="w-[100%] h-[320px] pad:h-[400px] b-pad:h-[480px] sm:h-[530px] md:h-[600px] lg:h-[400px] bg-center bg-no-repeat" />
