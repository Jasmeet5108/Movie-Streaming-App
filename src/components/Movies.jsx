...
const Moviecategory = (props) => {
    ...
    return (
        <div className="card mt-12 bmd:mt-24 w-[320px] pad:w-[400px] b-pad:w-[480px] sm:w-[530px] md:w-[600px] lg:w-[700px] blg:w-[600px] 2xl:w-[530px] border-black p-2 hover:cursor-pointer transition hover:scale-105">
            <img src={`https://image.tmdb.org/t/p/w500${img}`} alt="Image" loading='lazy' style={{ minWidth: "100%", maxWidth: "100%", minHeight: "100%", maxHeight: "100%" }} className="w-[100%] h-[250px] pad:h-[300px] b-pad:h-[400px] sm:h-[450px] md:h-[480px] lg:h-[550px] blg:h-[480px] 2xl:h-[450px] bg-center bg-no-repeat" />
